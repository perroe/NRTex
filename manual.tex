...
written by Harald H. Soleng and Anders Løland,  
redesigned by Lars Brusletto Sveen of Munch
Design, and again modified by Harald H. Soleng and Anders Løland.
\end{abstract}
...
Harald H. Soleng and Anders Løland. When   Munch
...
postscript files can be converted to pdf using the \texttt{eps2pdf}
