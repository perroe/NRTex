...
\documentclass[note,british,12pt]{nrdoc}
...
are handled by {Bib}\TeX\ \index{cite!BiB\TeX} and the
\texttt{natbib}\footnote{A simpler numerical\index{cite!numeric
  ...
  numerical citations due to external demands.} 
style. This style is automatically loaded by \texttt{nrdoc}. Some
...
\item[\textit{american}] u.s.\ english
  (default)\index{option!american} 
