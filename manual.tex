...
\documentclass[note,screen,citealphanumeric,british,12pt]{nrdoc}
...
\aboutauthors{Local \LaTeX\ gurus}
\date{\today}
\maketitle
...
\item confidential\index{availability!confidential}: Confedential. 
...
\section{The showlabels option}\index{option!showlabels}

This option prints equation labels in the margin.


\section{The nodesign option}\index{option!nodesign}
...
\section{The dvips option}\index{option!dvips}
