...
The \texttt{nrdoc} class is written by Lars Brusletto Sveen of Munch
Design and modified by Harald H. Soleng and Anders Løland.
\end{abstract}
...
\texttt{TEXINPUTS}\index{texinputs@TEXINPUTS} and \texttt{BSTINPUTS}\index{texinputs@BSTINPUTS} needs to be set. These
