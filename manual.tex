...
this option should not be used for a paper report. However, if you
want to print the report and want the lines and the NR logo on the
front page, but not the hyperlinks, use the option
\texttt{nolinks}\index{nolinks} together with the \texttt{screen} option.
